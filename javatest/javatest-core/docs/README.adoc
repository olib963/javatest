...
[source, java]
----
include::../src/test/java/io/github/olib963/javatest/documentation/MyCustomTestSuite.java[tags=include]
----
...
[source, java]
----
include::../src/test/java/io/github/olib963/javatest/documentation/MyRunners.java[tags=include]
----
...
* Option to set total timeout on eventual consistency rather than number of attempts
