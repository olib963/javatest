...
include::../src/test/java/io/github/olib963/javatest/parameterised/DocumentationTests.java[tags=palindrome]
...
include::../src/test/java/io/github/olib963/javatest/parameterised/DocumentationTests.java[tags=fibonacci]
